...
//!
//! This drives the *real* task-DAG engine (`mona_plan::dag`) with scripted mock
...
//!
//! Run with: `cargo run -p mona-plan --example swarm_agent_count`
//!
...
use mona_plan::dag::sim::deep_artifact;
use mona_plan::dag::{
