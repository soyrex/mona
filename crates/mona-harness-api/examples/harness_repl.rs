...
//!
//! Usage:
//!   cargo run -p mona-harness-api --example harness_repl -- \
//!     [socket_path] [message]
//!
...
//!   cargo run -p mona-harness-api --example harness_repl -- --demo
...
fn default_socket_path() -> String {
    ...
    format!("{home}/.mona/mona-api.sock")
}
        ...
        while {
            ...
            match req["req"].as_str().unwrap_or("") {
                ...
                "create_session" => reply(&ServerFrame::reply(
                    id,
                    ApiEvent::Attached {
                        session: mona_harness_api::SessionInfo {
                            edit_stats: None,
