...
//!
//! The graph model in `mona-tui-style::harmony::graph` needs to know which
...
use mona_tui_style::palette::role_for_rendered;
...
fn measure() -> (
    ...
    mona_tui_style::color::pin_truecolor_for_tests();
