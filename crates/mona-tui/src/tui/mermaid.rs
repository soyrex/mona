pub use mona_tui_mermaid::{
    ...
    init_picker, inline_fit_geometry, inline_fit_geometry_upscaled, inline_fit_readiness,
    ...
    register_external_image, register_inline_image, register_inline_level_geometries,
...
pub use mona_tui_mermaid::{ImageScrollBenchmark, cache_stat_syscalls};

#[cfg(feature = "mmdr-size-api")]
pub use mona_tui_mermaid::terminal_theme;

pub fn install_mona_mermaid_hooks() {
    mona_tui_mermaid::set_log_hooks(crate::logging::info, crate::logging::warn);
    mona_tui_mermaid::set_render_completed_hook(|| {
        crate::bus::Bus::global().publish(crate::bus::BusEvent::MermaidRenderCompleted);
    });
    mona_tui_mermaid::set_memory_snapshot_hook(|| {
        let snapshot = crate::process_memory::snapshot_with_source("client:mermaid:memory");
        mona_tui_mermaid::ProcessMemorySnapshot {
