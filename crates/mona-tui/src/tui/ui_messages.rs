...
fn render_compact_agent_notification(
    ...
    let collapsible = mona_tui_messages::parse_collapsible_swarm_content(content);
...
pub(crate) fn render_swarm_message(
    ...
    let collapsible = mona_tui_messages::parse_collapsible_swarm_content(&msg.content);
