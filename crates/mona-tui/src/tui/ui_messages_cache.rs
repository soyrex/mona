...
pub(super) use mona_tui_messages::{centered_wrap_width, left_pad_lines_for_centered_mode};
...
{
    mona_tui_messages::get_cached_message_lines(
        msg,
        width,
        diff_mode,
        mona_tui_messages::MessageCacheContext {
