...
pub(super) fn build_turn_notification(
    ...
    let mut title = String::from("mona");
...
mod tests {
    ...
    fn kitty_notification_is_one_completed_clickable_message() {
        ...
        assert_eq!(
            ...
            "\x1b]99;i=mona-turn-sessionfox123:d=0:e=1:p=title;amNvZGUgwrcgZm94\x1b\\\x1b]99;i=mona-turn-sessionfox123:d=1:e=1:p=body:a=focus;Mi8zIHRvZG9zCkZpbmlzaGVkIHBhcnNlcg==\x1b\\"
        );
    }
