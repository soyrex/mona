    ...
    } = notification_type
    {
        ...
        if !tldr.is_empty() && !presentation.message.trim().is_empty() {
            ...
            presentation.message =
                mona_tui_messages::encode_collapsible_swarm_content(tldr, &presentation.message);
        }
    }
    presentation
}
        ...
        NotificationType::FileConflict {
            ...
            SwarmNotificationPresentation {
                ...
                message: if has_details {
                    mona_tui_messages::encode_collapsible_swarm_content(
                        &summary_line,
                        &detail_body,
                    )
                } else {
...
mod tests {
    ...
    fn present_swarm_notification_with_tldr_encodes_collapsed_content() {
        ...
        let parsed = mona_tui_messages::parse_collapsible_swarm_content(&presentation.message)
    ...
    fn present_swarm_notification_without_tldr_keeps_plain_content() {
        ...
        assert!(
            mona_tui_messages::parse_collapsible_swarm_content(&presentation.message).is_none()
        );
