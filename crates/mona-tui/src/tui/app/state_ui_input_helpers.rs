...
const REGISTERED_COMMANDS: &[RegisteredCommand] = &[
    ...
    RegisteredCommand::public(
        "/skills",
        "Show loaded skills and mona-endorsed recommendations",
    ),
...
mod external_cli_suggestion_tests {
    ...
    /// Run with:
    ///   cargo test -p mona-tui --lib onboarding_suggestion_scan_cost -- --ignored --nocapture
    #[test]
    #[ignore]
