        ...
        json!({
            ...
            "properties": {
                ...
                "engine": {
                    ...
                    "description": "Engine. Defaults to duckduckgo; bing uses MONA_BING_API_KEY, searxng uses MONA_SEARXNG_URL."
                },
                "bing_market": {
                    "type": "string",
                    "description": "Optional Bing market, e.g. en-US or zh-CN. Defaults to MONA_BING_MARKET or en-US."
                }
            }
        })
    }
        ...
        if results.is_empty() {
            return Ok(ToolOutput::new(format!(
                "No results found for: {}\n\n\
                 ...
                 MONA_SEARXNG_URL) and use engine \"searxng\".\n\
                 - Or provide a Bing Search API key via MONA_BING_API_KEY.",
                params.query
            )));
        }
