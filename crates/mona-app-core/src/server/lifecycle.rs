...
const TEMP_SERVER_ENV: &str = "MONA_TEMP_SERVER";
const SERVER_SCOPE_ENV: &str = "MONA_SERVER_SCOPE";
const OWNER_PID_ENV: &str = "MONA_SERVER_OWNER_PID";
const TEMP_IDLE_SECS_ENV: &str = "MONA_TEMP_SERVER_IDLE_SECS";
