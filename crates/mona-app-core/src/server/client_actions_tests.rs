...
fn clone_split_session_uses_persisted_session_state() {
    ...
    parent.working_dir = Some("/tmp/mona-split-test".to_string());
...
impl SplitTestHome {
    fn new() -> Self {
        ...
        crate::env::set_var("MONA_HOME", directory.path());
        Self {
...
async fn enabling_swarm_does_not_auto_elect_coordinator() {
    ...
    let swarm_members = Arc::new(RwLock::new(HashMap::from([(
        ...
        crate::server::SwarmMember {
            ...
            working_dir: Some(PathBuf::from("/tmp/mona-passive-swarm")),
            swarm_id: None,
            swarm_enabled: false,
