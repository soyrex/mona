...
const SERVER_NAME_ENV: &str = "MONA_SERVER_NAME";
const SERVER_DISPLAY_NAME_ENV: &str = "MONA_SERVER_DISPLAY_NAME";
...
impl Server {
    ...
    pub fn new_with_name(provider: Arc<dyn Provider>, server_name: Option<String>) -> Self {
        ...
        let identity = ServerIdentity {
            ...
            name,
            icon,
            git_hash: mona_build_meta::git_hash().to_string(),
    ...
    fn spawn_registry_metadata_publisher(&self, registry_info: crate::registry::ServerInfo) {
        ...
        tokio::spawn(async move {
            ...
            let _ = std::fs::write(&hash_path, mona_build_meta::git_hash());
    ...
    fn spawn_power_inhibitor(swarm_members: Arc<RwLock<HashMap<String, SwarmMember>>>) {
        ...
        if !inhibitor.is_available() {
            ...
            crate::logging::info(
                "power_inhibit: unavailable (unsupported platform or MONA_DISABLE_POWER_INHIBIT set); not monitoring",
            );
            return;
        }
