...
impl Agent {
    ...
    pub fn model_catalog_snapshot(&self) -> mona_provider_core::ModelCatalogSnapshot {
    ...
    pub fn active_resolved_credential(&self) -> Option<mona_provider_core::ResolvedCredential> {
