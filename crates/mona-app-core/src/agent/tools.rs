...
pub(super) fn tool_output_side_pane_images(
    ...
    output: &ToolOutput,
) -> Vec<mona_session_types::RenderedImage> {
    ...
    output
        .images
        .iter()
        .map(|img| mona_session_types::RenderedImage {
            ...
            anchor: Some(mona_session_types::RenderedImageAnchor::ToolCall {
...
mod image_anchor_tests {
    ...
    fn live_batch_images_anchor_to_parent_and_have_no_history_boundary() {
        ...
        for image in &images {
            assert_eq!(
                image.anchor,
                Some(mona_session_types::RenderedImageAnchor::ToolCall {
