...
/// Mirrors `mona_plan::dag::NodeSpec` but kept as an explicit wire type so the
...
pub enum Request {
    ...
    SetCompactionMode {
        id: u64,
        mode: mona_config_types::CompactionMode,
    },
...
pub enum ServerEvent {
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<mona_provider_core::ModelRoute>,
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        resolved_credential: Option<mona_provider_core::ResolvedCredential>,
        ...
        #[serde(default)]
        compaction_mode: mona_config_types::CompactionMode,
    ...
    ModelUsageUpdated {
        route: mona_provider_core::ModelRoute,
    },
    ...
    CommListModelsResponse {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        model_routes: Vec<mona_provider_core::ModelRoute>,
    },
