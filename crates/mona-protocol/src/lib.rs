...
use mona_batch_types::BatchProgress;
use mona_message_types::{InputShellResult, ToolCall};
use mona_plan::{PlanItem, VersionedPlan, next_runnable_item_ids, summarize_plan_graph};
use mona_side_panel_types::{SidePanelSnapshot, snapshot_is_empty};
...
pub struct HistoryMessage {
    ...
    pub response_stats: Option<mona_session_types::ResponseStats>,
    pub role: String,
    pub content: String,
...
pub type ReloadRecoverySnapshot = mona_selfdev_types::ReloadRecoveryDirective;
...
impl PlanGraphStatus {
    ...
    pub fn from_versioned_plan(
        ...
        let growth = mona_plan::bridge::growth_stats(plan);
        ...
        Self {
            ...
            newly_ready_ids,
            low_confidence_ids: mona_plan::bridge::low_confidence_completed_ids(plan),
