...
//!
//! Run with: `cargo run --profile selfdev -p mona-tui-render --example swarm_gallery_preview`
...
use mona_tui_render::swarm_tiles::{SwarmGalleryConfig, SwarmTile, render_swarm_gallery};
use ratatui::prelude::*;
    ...
    let three = vec![
        mk(
            ...
            &[
                ...
                "Reading crates/mona-app-core/src/auth.rs",
        ...
        mk(
            ...
            "running",
            &[
                "Editing crates/mona-base/src/config.rs",
