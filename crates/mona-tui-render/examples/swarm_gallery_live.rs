...
//!
//! Run with:
//!   cargo run --profile selfdev -p mona-tui-render --example swarm_gallery_live
//!
//! Controls:
//!   q / Esc      quit
//!   + / -        more / fewer agents
...
use mona_tui_render::swarm_gallery::{GalleryMember, humanize_age, render_gallery};
