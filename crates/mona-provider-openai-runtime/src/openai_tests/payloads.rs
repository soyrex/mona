...
fn test_websocket_continuation_request_excludes_transport_fields() {
    ...
    assert_eq!(continuation["prompt_cache_key"], "mona-test-cache");
...
fn gpt_5_6_sol_defaults_to_low_reasoning_effort() {
    ...
    mona_base::auth::codex::set_active_account_override(Some("sol-low-default-test".to_string()));
