...
pub enum ErrorKind {
    ...
    Harness(mona_harness_api::ErrorCode),
...
impl ErrorKind {
    ...
    pub fn code(&self) -> &'static str {
        match self {
            ...
            Self::JcodeNotFound => "mona_not_found",
            ...
            Self::Harness(code) => match code {
                mona_harness_api::ErrorCode::UnsupportedVersion => "unsupported_version",
                mona_harness_api::ErrorCode::UnknownRequest => "unknown_request",
                mona_harness_api::ErrorCode::UnknownSession => "unknown_session",
                mona_harness_api::ErrorCode::InvalidRequest => "invalid_request",
                mona_harness_api::ErrorCode::Internal => "internal",
            },
        }
    }
}
...
impl From<mona_harness_api::FrameError> for Error {
    fn from(error: mona_harness_api::FrameError) -> Self {
        let kind = match error {
            mona_harness_api::FrameError::Eof => ErrorKind::Disconnected,
