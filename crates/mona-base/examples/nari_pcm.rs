...
//!
//! cargo run -p mona-base --no-default-features --example nari_pcm -- --live sample.pcm
//!
//! Uses NARI_API_KEY or the existing private nari.env configuration. For isolated
//! acceptance, set MONA_HOME and MONA_RUNTIME_DIR to a scratch directory and
//! configure NARI_API_KEY through your normal secret delivery mechanism.
use mona_base::voice::{NariEvent, NariSession, VoiceError, nari_api_key, nari_pcm_channel};
use std::{
    io::Read,
