...
use mona_session_types::{ResponseStats, StoredMessage};
...
fn attach_turn(
    ...
    let sum = |field: fn(&mona_session_types::StoredTokenUsage) -> Option<u64>| {
...
mod tests {
    use super::*;
    use mona_session_types::StoredTokenUsage;
    ...
    fn response_stats_internal_rows_do_not_split_and_overflow_is_unknown() {
        ...
        internal.display_role = Some(mona_session_types::StoredDisplayRole::System);
        let messages = vec![
