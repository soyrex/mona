...
///
/// The drivers themselves live downstream in the `mona-provider-doctor`
...
/// crate. A sync test in `mona-provider-doctor` asserts this list matches its
...
mod tests {
    ...
    fn base_assessment() -> ProviderAuthAssessment {
        ProviderAuthAssessment {
            ...
            credential_source_detail: "~/.mona/auth.json".to_string(),
