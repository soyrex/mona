...
const CLIENT_ID_ENV: &str = "MONA_ANTIGRAVITY_CLIENT_ID";
const CLIENT_SECRET_ENV: &str = "MONA_ANTIGRAVITY_CLIENT_SECRET";
...
pub fn tokens_path() -> Result<std::path::PathBuf> {
    Ok(crate::storage::mona_dir()?.join("antigravity_oauth.json"))
}
