...
//!
//! Data persists to `~/.mona/provider_activity.json` and is shared across
...
pub fn display_name_for_source_key(source_key: &str) -> String {
    ...
    match source_key {
        ...
        "mona" => "Jcode subscription".to_string(),
...
/// `"NVIDIA NIM"`) plus the optional `MONA_RUNTIME_PROVIDER` key onto a
...
mod tests {
    ...
    #[test]
    fn record_use_and_spend_roundtrip_under_mona_home() {
