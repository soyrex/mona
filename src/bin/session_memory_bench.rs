...
use mona::message::{ContentBlock, Role};
use mona::process_memory;
...
fn main() -> anyhow::Result<()> {
    ...
    let display_messages = mona::tui::display_messages_from_session(&session);
    ...
    let client_memory = mona::tui::transcript_memory_profile(
        &session,
