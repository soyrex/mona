...
pub(super) async fn login_mona_device_flow(no_browser: bool) -> Result<LoginCompletion> {
    ...
    crate::telemetry::record_auth_success("mona-subscription", "device_code_browser");
    Ok(completion)
}
