...
pub(crate) fn configure_provider_profile(
    ...
    Ok(ProviderSetupReport {
        ...
        auth_test_command: format!(
            ...
            shell_quote(&name),
            shell_quote("Reply exactly MONA_PROVIDER_SETUP_OK")
        ),
    })
}
...
mod tests {
    ...
    fn provider_add_writes_named_profile_env_file_and_default() {
        ...
        let _key = EnvVarGuard::remove("MONA_PROVIDER_MY_API_API_KEY");
        ...
        assert_eq!(
            ...
            Some("MONA_PROVIDER_MY_API_API_KEY")
        );
        ...
        assert!(env_content.contains("MONA_PROVIDER_MY_API_API_KEY=secret-test-key"));
    }
