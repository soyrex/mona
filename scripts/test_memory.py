...
Usage:
    # With existing server (uses /run/user/1000/mona-debug.sock)
...
def main():
    ...
    if args.fresh:
        ...
        test_socket = '/tmp/mona-memory-test.sock'
        ...
        socket_path = args.socket or '/run/user/1000/mona-debug.sock'
