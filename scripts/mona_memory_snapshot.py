...
def iter_mona_processes(main_socket: str, include_aux: bool) -> Iterable[ProcMem]:
...
def main() -> int:
    args = parse_args()
    procs = list(iter_mona_processes(args.socket, args.include_aux))
